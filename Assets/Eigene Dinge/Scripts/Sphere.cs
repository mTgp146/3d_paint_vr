...
public class Sphere : MonoBehaviour
{
    ...
    private GameObject shownSphere;
    ...
    void Start() {
        ...
        shownSphere = GameObject.CreatePrimitive(PrimitiveType.Sphere);
        shownSphere.transform.position = new Vector3(pos.position.x, pos.position.y, pos.position.z);
        shownSphere.transform.rotation = pos.rotation;
        shownSphere.transform.localScale = new Vector3(sphereRadius, sphereRadius, sphereRadius);
        shownSphere.GetComponent<Renderer>().material = drawingMaterial;
    }
    ...
    public void SpawnSphere() {
        if(start == false) {
            ...
            newSphere.tag = "Painted";
            BoxCollider collider = newSphere.AddComponent<BoxCollider>();
            collider.isTrigger = true;
            
            newSphere.transform.position = new Vector3(pos.position.x, pos.position.y, pos.position.z);
            newSphere.transform.rotation = pos.rotation;
            newSphere.transform.localScale = new Vector3(sphereRadius, sphereRadius, sphereRadius);
    ...
    void SwitchColor() {
        ...
        colorChanging = true;
        start = false;
        ColorPicker.Create(sphereRadius, drawingMaterial.color, "Choose a new color", SetColor, ColorFinished, true);
    }
