...
public class ColorPicker : MonoBehaviour
{
    ...
    public delegate void ColorEvent(Color c, float rad);
    ...
    private static float modifiedRad;
    ...
    /// </returns>
    public static bool Create(float radius, Color original, string message, ColorEvent onColorChanged, ColorEvent onColorSelected, bool useAlpha = false)
    {   
        if(instance is null)
        {
    ...
    private void RecalculateMenu(bool recalculateHSV)
    {
        ...
        radComponent.value = modifiedRad;
        ...
        onCC?.Invoke(modifiedColor, modifiedRad);
        interact = true;
    }
    ...
    public static void Done()
    {
        ...
        onCC?.Invoke(modifiedColor, modifiedRad);
        onCS?.Invoke(modifiedColor, modifiedRad);
